...
export const programs: Program[] = [
  {
    slug: "Legal Quiz Competition",
    title: "Legal Quiz Competition",
    category: "Education",
    description:
      "A structured program equipping young people with core chess skill competencies through competition, mentorship, and real-world challanges.",
    longDescription:
    ...
    highlights: [
      "Multi-Days structured curriculum",
      "Mentorship from experienced leaders",
      "Alumni network and continued support",
    ],
  },
  {
    slug: "Ghar Nirman Mela Health Desk",
    title: "Ghar Nirman Mela 2083 – Health Desk",
    category: "Health",
    description:
      "A community health initiative providing basic health checkups, blood pressure monitoring, primary health consultation, and health awareness information to participants and visitors of Ghar Nirman Mela 2083.",
    longDescription:
    ...
    status: "completed",
    impact:
      "Community members reached through basic health services and health awareness",
    highlights: [
      "General health checkups for mela participants and visitors",
      "Blood pressure (BP) monitoring",
      "Primary health consultation",
      "Health-related awareness and educational information",
      "Youth-led community health service",
    ],
  },
  {
    slug: "Nuwakot Mobile Health Camp",
    title: "Nuwakot Mobile Health Camp",
    category: "Health",
    description:
      "A mobile health initiative bringing essential medical, psychosocial, and health awareness services directly to flood-affected communities in Nuwakot.",
    longDescription:
    ...
    status: "ongoing",
    impact:
      "Essential healthcare and psychosocial support delivered to flood-affected communities",
    highlights: [
      "14-day mobile health camp",
      "Healthcare services delivered directly to flood-affected communities",
      "Multidisciplinary team of 6 health professionals and students",
      "Basic medical treatment and health consultation",
      "Psychosocial support and psychological counseling",
      "Health awareness and community education",
    ],
  },

  {
    slug: "Rasuwa Relief Campaign",
    title: "Rasuwa Relief Campaign",
    category: "Disaster Relief",
    description:
      "A youth-led disaster relief initiative delivering essential relief materials to communities affected by the disaster in Rasuwa through collaboration between Gen Z Youth Parsa Team and Nepal Emerging Youth.",
    longDescription:
    ...
    status: "ongoing",
    impact:
      "Relief materials being delivered to disaster-affected communities in Rasuwa",
    highlights: [
      "Collaboration between Gen Z Youth Parsa Team and Nepal Emerging Youth",
      "Youth-led disaster response and humanitarian action",
      "Relief materials distributed to affected communities",
      "Direct field-level support to disaster-affected families",
      "Youth solidarity and community mobilization",
      "Promoting hope, resilience, and humanitarian service",
    ],
  },

  {
    slug: "CodeFest Madhesh Pradesh",
    title: "CodeFest Madhesh Pradesh – Community & Medical Support",
    category: "Community & Health",
    description:
      "A community partnership initiative where Nepal Emerging Youth supports CodeFest Madhesh Pradesh in Birgunj through volunteer coordination and on-site medical services.",
    longDescription:
    ...
    status: "completed",
    impact:
      "Volunteer and medical support provided to participants and attendees of CodeFest Madhesh Pradesh",
    highlights: [
      "NEY participated as a partner organization through its Community Department",
      "NEY volunteer team supporting the event",
      "On-site medical services throughout the program",
      "Medical support from Dr. Manoj Jung Thapa and Dr. Daimond Thungana",
      "Youth engagement in technology and community initiatives",
      "Promoting safe, inclusive, and community-centered events",
    ],
  },

  {
    slug: "Nepal Youth Rights Mega Meet",
    title: "7th Nepal Youth Rights Mega Meet",
    category: "Youth Advocacy",
    description:
      "A national youth advocacy platform bringing together young people, parliamentarians, civil society organizations, and thematic experts to strengthen youth participation, rights, and collective advocacy.",
    longDescription:
    ...
    status: "completed",
    impact:
      "200+ young people engaged alongside parliamentarians, experts, and 35+ civil society organizations",
    highlights: [
      "7th Nepal Youth Rights Mega Meet",
      "Partnership with Youth Advocacy Nepal and 35+ civil society organizations",
      "Participation of 200+ young people from across Nepal",
      "Engagement of parliamentarians and thematic experts",
      "Thematic panel discussions on youth rights and participation",
      "Platform for young people to share experiences and raise key issues",
      "Strengthening collective advocacy for youth rights",
      "Promoting an inclusive, equitable, and just society",
    ],
  },
  {
    slug: "Mascot Academy School Health Camp",
    title: "School Health Awareness Program & Health Camp",
    category: "Health",
    description:
      "A school-based health initiative providing dental and eye screenings while promoting health awareness and better well-being among students in Birgunj.",
    longDescription:
    ...
    status: "completed",
    impact:
      "Students reached through health awareness, dental screening, and eye check-up services",
    highlights: [
      "School-based health awareness program",
      "Dental check-ups for students",
      "Eye screening and check-ups",
      "Health education focused on student well-being",
      "Leadership by Mr. Sushant Singh Thakuri, NEY Ambassador",
      "Collaboration with Smile Dental and Polyclinic",
      "Collaboration with Drishti Eye Hospital",
    ],
  },
  {
    slug: "Sundarlal Kaniya School Health Camp",
    title: "School Health Camp & Awareness Program",
    category: "Health",
    description:
      "A school-based health initiative providing dental and general health checkups alongside awareness sessions on female teenage health, menstrual hygiene, PCOS, and proper oral hygiene.",
    longDescription:
    ...
    status: "completed",
    impact:
      "Students reached through health checkups and adolescent health and hygiene awareness",
    highlights: [
      "Dental checkups for students",
      "General health checkups",
      "Awareness on female teenage health",
      "Menstrual hygiene education",
      "PCOS awareness",
      "Proper tooth brushing and oral hygiene education",
      "Partnership with Smile Dental Clinic, Birgunj",
      "Coordination by Mr. Pawan Mandal",
    ],
  },
  {
  slug: "Digital Health and Social Media Awareness",
  title: "Digital Health & Social Media Awareness Program",
  category: "Digital Health",
  description:
    "A student-focused awareness program promoting digital health, responsible social media use, cyber safety, screen-time management, and informed digital behavior.",
  longDescription:
  ...
  status: "completed",
  impact:
    "Class 11 and 12 students reached through digital health, cyber safety, and responsible social media awareness",
  highlights: [
    "Digital health and social media awareness sessions",
    "Cyber safety and online risk awareness",
    "Education on cyberbullying and misinformation",
    "Screen-time management and digital addiction awareness",
    "Interactive group discussions and Q&A sessions",
    "Student-focused activities promoting responsible digital behavior",
    "Pre-test and post-test assessments to measure learning outcomes",
    "Strengthening students’ critical thinking and digital awareness",
  ],
},
{
  slug: "Rajhena Mental Health and Handwashing Awareness",
  title: "Mental Health & Handwashing Awareness Program",
  category: "Health Awareness",
  description:
    "A school-based awareness initiative promoting mental health awareness among Class 8 students alongside practical education on proper handwashing and personal hygiene.",
  longDescription:
  ...
  status: "completed",
  impact:
    "Class 8 students and community members reached through mental health and handwashing awareness",
  highlights: [
    "Mental health awareness session for Class 8 students",
    "Handwashing and personal hygiene awareness",
    "Promotion of healthy everyday practices",
    "Student-focused health education",
    "Awareness led by Dr. Aakriti Pandey, NEY Ambassador 2026",
    "Promoting healthier and more informed communities",
  ],
},
...
export const featuredInitiatives: import("@/types").FeaturedInitiative[] = [
  ...
  {
    slug: "Codefest Campus Visit",
    title: "Empowering Young Developers",
    description:
