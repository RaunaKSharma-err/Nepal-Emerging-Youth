...
*NEW JOINEE REQUEST — NEPAL EMERGING YOUTH (NEY)*
...
This message was submitted through the official Nepal Emerging Youth (NEY) website.
      `.trim();
            ...
            <Reveal>
              <div>
                ...
                <div className="mt-6 flex aspect-[16/9] items-center justify-center rounded-xl border border-dashed border-border bg-muted/30">
                    ...
                    <iframe
                      title="Nepal Emerging Youth - Birgunj Location"
                      src="https://www.google.com/maps?q=Birgunj,+Parsa,+Nepal&output=embed"
                      width="100%"
                      height="320"
                      style={{ border: 0 }}
                      loading="lazy"
